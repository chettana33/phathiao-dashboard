...
**ภาพรวม:** vector search งานพาเที่ยว — corpus = Gochisou + PC + checkpoint + lessons + rules + SOP + ความรู้ทั้งระบบ · store local `vec_test` · เสร็จ **7/8 ส่วน** · default = **local bge-m3** (6 ก.ย. 69 พี่เจเลือก)
...
| 8 | auto-load ใน `/work` | 50% | in_progress | พาเที่ยว | skill auto-start + auto-review มุมคนนอก เสร็จ 7 ก.ย. (§10 ข้อ 1/§24) · chroma hint (คืน src/section) = design พร้อม รอทำ |
